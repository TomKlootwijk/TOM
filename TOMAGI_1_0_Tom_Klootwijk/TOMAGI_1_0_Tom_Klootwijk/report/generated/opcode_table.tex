...
2 & JIT1 & Derive a deterministic parity bit and add +/-arg0 to the selected field. \\
3 & KIN2 & Apply integer second-order update v'=v+args; q'=q+v'. \\
4 & PHI & Advance lower-case phi modulo 2\textasciicircum{}12 and expose wrap/half-circle branch. \\
...
7 & CONE & Evaluate a quantized log-polar cone/support relation. \\
8 & SPHERE & Evaluate a quantized radial/phi shell relation. \\
9 & KLEIN & Apply reflective Klein or source half-turn radial wrap. \\
10 & RADIX & Select one bit of the canonical 64-bit key. \\
11 & HINGE & Apply map1 deltas and optional orientation/sheet flips when branch=1. \\
...
14 & EMIT & Set output token and emitted status; flag bit 0 may terminate the program. \\
