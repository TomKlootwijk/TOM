...
def _validate_operation_parameter_shape(
    ...
    if op == "literal":
        ...
        default_ticks = _int(params.get("default_ticks", 0))
        if default_ticks < 0:
            raise ValueError(f"definition {ident} default_ticks must be non-negative")
    ...
    *,
    ...
    for ident in selected_order:
        ...
        if op == "seed.bytes":
            ...
            if default_ticks < 0:
                raise ValueError("program.construct default_ticks must be non-negative")
